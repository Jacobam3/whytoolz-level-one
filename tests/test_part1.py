...
try:
    from src import whytoolz_part1 as wt
except ImportError:
    # If module doesn't exist, create a dummy for testing
    import sys
    from types import ModuleType
    wt = ModuleType('whytoolz_part1')
...
def test_part1():
    ...
    def test_groupby():
        ...
        def test_groupby_numeric():
            def is_odd(x):
                return x % 2
            result = wt.groupby(is_odd, [1, 2, 3, 4, 5, 6])
        ...
        def test_groupby_property():
            ...
            result = wt.groupby(get_age, data)
        ...
        def test_groupby_order():
            def is_positive(x):
                return x > 0
            result = wt.groupby(is_positive, [1, -2, 3, -4, 5])
